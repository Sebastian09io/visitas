...
class GestionPerfilTests(TestCase):
    def setUp(self):
        ...
        self.cargo_analista = Cargo.objects.create(nombre='Analista')
        ...
        self.user = User.objects.create_user(
            ...
            is_superuser=True,  # Establecer is_superuser en True
    ...
    def test_cerrar_sesion(self):
        ...
        """
        url = reverse('reservas:cerrar_sesion')
    ...
    def test_inhabilitar_cuenta(self):
        ...
        """
        url = reverse('reservas:inhabilitar_cuenta')
    ...
    def test_actualizar_imagen_perfil(self):
        ...
        """
        url = reverse('reservas:actualizar_imagen_perfil')
    ...
    def test_eliminar_imagen_perfil(self):
        ...
        self.user.save()
        url = reverse('reservas:eliminar_imagen_perfil')
        response = self.client.post(url)
        self.assertEqual(response.status_code, 200)
    ...
    def test_listar_datos_perfil(self):
        ...
        """
        url = reverse('reservas:gestion_perfil')
        response = self.client.get(url)
        self.assertEqual(response.status_code, 200)
